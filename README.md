...
💁 Обо мне: Продуктовый аналитик с глубоким опытом научных исследований, что позволяет подходить к данным с особой строгостью.🚀 Владею полным циклом анализа: от формулировки гипотез и сбора данных (SQL) до их обработки (Python), визуализации (Yandex DataLens) и презентации бизнес-выводов.
